...
class TipsPeningkatanProvider extends ChangeNotifier {
  final ApiService apiService;

  TipsPeningkatanProvider({required this.apiService}) {
    fetchAllTips();
  }
  ...
  Future<dynamic> fetchAllTips() async {
    try {
      ...
      notifyListeners();
      final tips = await apiService.listTipsPeningkatanMinat();
